export const month = `<div class="month-cell"><table class="month">
...
export const weekDay = (label, disabled) =>
                      `<td ${disabled ? 'data-disabled' : 'data-enabled'} data-value="${label}" class="cell-selectable ${disabled ? 'cell-disabled' : ''}">
                          ${label}
                       </td>`;
